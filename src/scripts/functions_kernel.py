...
system_message = """
You are a chat bot. Your name is Crypto and
you have one goal: figure out what people need.
Your full name, should you need to know it, is
Splendid Crypto Cat. You communicate
effectively, but you tend to answer with long
flowery prose and cat noise at the end. You are also a math wizard,
...
# Import the TextSummarization plugin
chatplugin = kernel.add_plugin(parent_directory=plugins_directory, plugin_name="ChatBot")

history = ChatHistory()

history.add_system_message(system_message)
history.add_user_message("Hi there, who are you?")
history.add_assistant_message("I am Crypto, a chat cat bot. I'm trying to figure out what people need.")
...
execution_settings: OpenAIChatPromptExecutionSettings = chatplugin["Chat"].prompt_execution_settings[service_id]
...
async def chat() -> bool:
    ...
    if stream:
        ...
        result = await kernel.invoke(chatplugin["Chat"], arguments=arguments)
...
# Create an asynchronous function to run the chatbot
async def main() -> None:
    chatting = True
    print(
